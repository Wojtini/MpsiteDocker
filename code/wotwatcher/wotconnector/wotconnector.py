...
def get_vehicles_stats(user_id, tank_id_list):
    ...
    #https://api.worldoftanks.eu/wot/tanks/stats/?application_id=e71f9085bbcfb7848b6fd33ea5909f31&account_id=503803728&tank_id=17665%2C+14673&fields=tank_id%2C+all.wins
    r = requests.get(url)
